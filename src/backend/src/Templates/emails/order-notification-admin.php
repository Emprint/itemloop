<?php
/**
 * Email template: order-notification-admin
 * Variables: $orderId, $customerName, $customerEmail, $orderItems (array of {name,qty,price}), $orderTotal, $currency
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.08);">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="margin:0 0 16px;color:#374151;line-height:1.6;"><?= htmlspecialchars($t['body']) ?></p>

          <table cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td style="color:#6b7280;font-size:13px;padding-right:12px;"><?= htmlspecialchars($t['customer']) ?></td>
              <td style="color:#111827;font-weight:600;"><?= htmlspecialchars($customerName) ?></td>
            </tr>
            <tr>
              <td style="color:#6b7280;font-size:13px;padding-right:12px;"><?= htmlspecialchars($t['email']) ?></td>
              <td style="color:#111827;"><?= htmlspecialchars($customerEmail) ?></td>
            </tr>
          </table>
