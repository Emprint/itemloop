...
|---------|-------------------------|---------------------|----------|-----------------------------------|
| Admin   | admin@itemloop.local    | iL-Adm!n#dev2025    | active   | Main admin account                |
| Editor  | editor@itemloop.local   | iL-Ed!t0r#dev2025   | active   | Editor-level access               |
...
- **Test Product**: ISBN 978-0-13-468599-1 / "The Pragmatic Programmer"